...
import { Route as AppLeadsIndexImport } from './routes/app/leads/index'
...
const AppLeadsIndexRoute = AppLeadsIndexImport.update({
  id: '/leads/',
  path: '/leads/',
  getParentRoute: () => AppRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/app/leads/': {
      ...
      path: '/leads'
      fullPath: '/app/leads'
      preLoaderRoute: typeof AppLeadsIndexImport
      parentRoute: typeof AppImport
    }
    '/app/locations/': {
      id: '/app/locations/'
